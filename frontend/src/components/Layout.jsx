...
const NAV = [
  ...
  { to: "/products",  icon: "◈", label: "Data Penduduk" },
  { to: "/karyawan",  icon: "👥", label: "Data Karyawan" },
    ...
    <div className={styles.shell}>
      ...
      <aside className={styles.sidebar}>
        <div className={styles.logo}>
          <span className={styles.logoMark} style={{background: "var(--indigo)", color: "#fff"}}>D</span>
          <span className={styles.logoText}>Dukcapil App</span>
        </div>
