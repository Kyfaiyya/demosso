...
export default function App({ keycloak }) {
  ...
  const [appRegistered, setAppRegistered] = useState(null);
  ...
  if (loading) {
    return <div style={{ display:"flex", alignItems:"center", justifyContent:"center", height:"100vh", color:"var(--muted)" }}>Memuat...</div>;
  }
