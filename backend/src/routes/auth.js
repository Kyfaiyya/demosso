...
// POST /api/auth/introspect  — validate & decode token
...
// POST /api/auth/logout-backend  — server-side logout (revoke refresh token)
...
// GET /api/auth/keycloak-config  — config untuk frontend
